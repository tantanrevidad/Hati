...
export default function App() {
  ...
  return (
    <>
      ...
      {currentScreen === 'profile' && <ProfileScreen onNext={(name, color, avatar) => {
          setUserName(name); localStorage.setItem('userName', name);
          setUserColor(color); localStorage.setItem('userColor', color);
          if (avatar) {
            setUserAvatar(avatar); localStorage.setItem('userAvatar', avatar);
          } else {
            setUserAvatar(null); localStorage.removeItem('userAvatar');
          }
