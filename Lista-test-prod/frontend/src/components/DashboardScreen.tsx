...
export default function DashboardScreen({ groups, expenses, setExpenses, onCreateGroup, onLogout, onAddBillingMethod, userName, userColor, userAvatar, initialMenuOpen = false }: DashboardScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F3EFE7] dark:bg-[#121212] font-sans pb-28">
      ...
      <header className="bg-white dark:bg-slate-900 border-b border-[#C8DACF] dark:border-slate-800 px-6 py-4 sticky top-0 z-20 flex justify-between items-center">
        <div>
          <h1 className="text-2xl tracking-tighter text-[#13463B] dark:text-white flex items-baseline" style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 900, letterSpacing: "-0.04em" }}>
            <span className="inline-flex items-baseline">
              <span className="leading-none" style={{ marginLeft: '-0.06em' }}>L</span>
              <span className="relative inline-flex items-baseline justify-center" style={{ marginLeft: '0.04em' }}>
                <span className="leading-none" style={{ fontSize: '0.65em' }}>I</span>
                <span className="absolute bottom-[0.66em] left-[62%] -translate-x-1/2 w-[0.2em] h-[0.2em] bg-[#10C86E] rounded-full"></span>
              </span>
              <span className="leading-none" style={{ marginLeft: '0.04em' }}>S</span>
              <span className="leading-none" style={{ marginLeft: '0.02em' }}>T</span>
              <span className="leading-none" style={{ marginLeft: '-0.1em' }}>A</span>
            </span>
          </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {userAvatar ? <img src={userAvatar} alt="Profile" className="w-full h-full object-cover rounded-full" /> : userName ? userName.charAt(0).toUpperCase() : <User size={18} />}
          </button>
        </div>
      </header>
              ...
              <div className="px-6 py-6 border-b border-[#C8DACF] dark:border-slate-800 flex justify-between items-center bg-[#F3EFE7] dark:bg-[#121212]">
                <div className="flex items-center gap-3">
                  <div className={`w-12 h-12 rounded-full ${userColor || 'bg-[#236450]'} border-2 border-[#F3EFE7] dark:border-[#30373C] flex items-center justify-center text-white font-bold shadow-sm`}>
                    {userAvatar ? <img src={userAvatar} alt="Profile" className="w-full h-full object-cover rounded-full" /> : userName ? userName.charAt(0).toUpperCase() : <User size={22} />}
                  </div>
                  <div>
