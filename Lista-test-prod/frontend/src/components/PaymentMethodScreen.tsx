        ...
        <div className="relative z-10">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl p-6 sm:p-8 border-2 border-[#C8DACF] dark:border-slate-800 relative z-10">
            ...
            <div className="text-center mb-8 mt-2">
              <h2 className="text-3xl font-black text-[#13463B] dark:text-white font-sans tracking-tight">Payment Setup</h2>
            ...
            {error && (
              <motion.div 
                ...
                className="mb-6 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 p-3 rounded-xl flex items-start gap-2 text-sm border border-red-200 dark:border-red-800/50 shadow-sm"
              >
