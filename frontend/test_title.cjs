...
// Replace the title rendering block
...
let newTitleBlock = `<motion.h1
          ...
          >
            {/* The "border" the title must not go past */}
              ...
              {[
                ...
                >
                  <div className="relative flex items-center justify-center">
                    <span className={item.char === 'i' ? "mt-[0.15em]" : ""}>
                    ...
                    {item.greenDot && (
                      <motion.span 
                        ...
                        transition={{ duration: 0.4, type: "spring", delay: 0.2 + index * 0.08 + 0.4 }}
                        className="absolute top-[0.02em] left-1/2 -translate-x-1/2 w-[0.24em] h-[0.24em] bg-[#10C86E] rounded-full"
                      ></motion.span>
                    )}
                  </div>
                </motion.div>
