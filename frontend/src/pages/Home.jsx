      ...
      <div className="page">
        ...
        <div className="card anim-fade-up stagger-1" style={{
          ...
          <div className="card-body" style={{ position: "relative", zIndex: 1 }}>
            <p style={{ fontSize: "0.8125rem", color: "rgba(255,255,255,0.7)", marginBottom: 4, fontWeight: 600 }}>
              NET BALANCE
            </p>
            <div style={{ fontSize: "2.25rem", fontWeight: 800, color: "#fff", marginBottom: 20 }}>
