                ...
                {groupExpenses.map((expense) => {
                  ...
                  <div key={expense.id} className="flex items-center justify-between border-b border-[#C8DACF] dark:border-slate-800 pb-3 last:border-0 last:pb-0">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-bold text-[#13463B] dark:text-white leading-tight text-sm">{expense.title}</h4>
            ...
            >
              ...
              <div className="space-y-3 mb-6 max-h-48 overflow-y-auto pr-2">
                {activeOwes.length === 0 ? (
                  ...
                  activeOwes.map((owe, i) => (
                    <div key={i} className="p-4 rounded-2xl border border-[#C8DACF] dark:border-slate-800 flex justify-between items-center">
                      <div>
              ...
              {activeOwes.length > 0 && (
                <div className="mb-6 flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/50">
                  ...
                  <span className="font-bold text-[#13463B] dark:text-white text-sm tracking-wide">Scan to Pay via QRPH</span>
                </div>
              )}
              ...
              {activeOwes.length > 0 && (
                <button 
                  ...
                  className="w-full bg-[#13463B] hover:bg-slate-800 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-900 py-4 rounded-2xl font-bold transition-colors mb-3"
                >
        ...
        {showScanner && (
          ...
          >
            <motion.div
              ...
              onClick={e => e.stopPropagation()}
            >
              <div className="h-72 bg-[#13463B] relative flex items-center justify-center overflow-hidden">
